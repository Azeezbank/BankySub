        ...
        <aside>
            ...
            <div className="grid-navDashh">
              ...
              <div className="grid-navDash">
                ...
                <Link to={'/vend=airtime'} className='Link'><p className='ps-2 Link'>Buy Airtime</p></Link>
              </div>
              <div className="grid-navDash">
                <h3>
          ...
          <main>
            ...
            <div className='airtimeForm grid-balance-section-m'>
                ...
                <form className='transactionForm'>
                    ...
                    <div className='input-group'>
                        <p className='input-group-text bg-light'>NGN.</p>
                        <input type='text' placeholder='Amount To Pay' className='form-control' disabled/>
                        <p className='input-group-text bg-light'>.00</p>
                    </div>
                    <div className='flex-bypass'>
                    <p><input type='checkbox' name='bypass' id='bypass' /></p> <label htmlFor={'bypass'}>Bypass Number Validator</label>
                    </div>
