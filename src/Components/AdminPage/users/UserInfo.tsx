...
const UserInfo: React.FC = () => {
    ...
    const UserDetails = async () => {
        try {
            const response = await axios.get(`https://bankysub-api.onrender.com/api/user/info/${id}`, { withCredentials: true });
    ...
    const handleUpdateUser = async (fieldName: any, value: any) => {
        try {
            const response = await axios.put(`https://bankysub-api.onrender.com/api/user/update/${id}`, { fieldName, value }, { withCredentials: true });
            if (response.status === 200) {
    ...
    const handleUpdateWallet = async () => {
        setIsLOading(false);
        try {
            const response = await axios.post(`https://bankysub-api.onrender.com/api/user/fund/${id}`, { amount }, { withCredentials: true });
            if (response.status === 200) {
    ...
    const handleBanUser = async () => {
        try {
            setIsBanning(false);
            const response = await axios.put(`https://bankysub-api.onrender.com/api/user/ban/${id}`, {}, { withCredentials: true });
            if (response.status === 200) {
